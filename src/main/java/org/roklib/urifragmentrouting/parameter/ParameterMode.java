...
public enum ParameterMode {
     ...
     * <p>
     * Example: If there are two path segment mappers defined (e. g. <tt>category</tt> and <tt>product</tt>) each of
     ...
     * parameter name cannot be used with more than one mapper. This is because in query mode there is no way for a
     ...
     * without including the parameter names in the URI fragment.
     * <p>
     * Example: If there are two path segment mappers defined (e. g. <tt>category</tt> and <tt>product</tt>) each of
     * which has one registered parameter (e. g. <tt>category</tt> is assigned a parameter <tt>name</tt> and
     * <tt>product</tt> is assigned a parameter <tt>id</tt>) then the following URI fragment would be an example for
    ...
    /**
     * Specifies that URI parameters registered for a path segment mapper are listed after the corresponding mapper name
     * including the parameter names in the URI fragment.
     * <p>
     * Example: If there are two path segment mappers defined (e. g. <tt>category</tt> and <tt>product</tt>) each of
     * which has one registered parameter (e. g. <tt>category</tt> is assigned a parameter <tt>name</tt> and
     * <tt>product</tt> is assigned a parameter <tt>id</tt>) then the following URI fragment would be an example for
     * the directory with names mode:
     * <p>
