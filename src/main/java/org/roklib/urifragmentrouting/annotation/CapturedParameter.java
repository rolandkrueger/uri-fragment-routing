 ...
 * with its class type set to the type of the requested URI parameter. E. g. if you're using a URI fragment parameter of
 * type {@link org.roklib.urifragmentrouting.parameter.SingleDateUriParameter} with parameter name <tt>startDate</tt> on
 * a mapper with name <tt>list</tt> then the method annotated with this annotation could be annotated as follows:
 * <p>
 * <pre>
