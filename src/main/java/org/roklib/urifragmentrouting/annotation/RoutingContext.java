 ...
 * of the interpretation process access to application services, such as an event bus. This annotation can be used on
 * methods of classes implementing {@link org.roklib.urifragmentrouting.UriActionCommand UriActionCommand}.
 * <p>
