 ...
 * is annotated with one of the annotations from package <tt>annotation</tt> does not adhere to the required format.
 * This may happen, for example, when such a method does not have the expected parameter type or more than one
 * parameter.
 */
